        ...
        <div class="card-body">
          ...
          @csrf
            <div class="form-group">
              <label for="category">Venue Konser</label><br>
              <select
            ...
            <div class="form-group">
              <label for="start">Tiket Masuk</label><br>
              <select
                class="select2 form-control"
                id="start"
                name="start"
            ...
            <div class="form-group">
              ...
              <select
                ...
                required
              >
                <option value="" disabled selected>-- Nomer ID Tiket --</option>
            ...
            <div class="form-group">
              <label for="waktu">Check-Out</label>
              <input
                type="date"
                class="form-control"
                id="waktu"
